...
(function () {
	...
	function linkToUpdateSets() {
		if (location.href.indexOf('/rm_story.do') >= 0 || location.href.indexOf('/rm_defect.do') >= 0) {
			var number = g_form.getValue('number') + '';
			var link = 'https://sim-dev.srv.allianz/sys_update_set_list.do?sysparm_query=nameLIKE' + number;
